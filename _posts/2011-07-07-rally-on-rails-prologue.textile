...
disqus_title: Rally on Rails - Prologue 
layout: post
tags: rally&nbsp;on&nbsp;rails
keywords: rally on rails, rallyonrails, rubyoverflow, ruby overflow 
meta_desc: The Rally on Rails contest is about to begin and the RubyOverflow team is gathering togheder.
identifier: rally_on_rails_day_1
---

Finally the very first "(tblank)Rally on Rails":http://rallyonrails.com/ contest has opened its registration. As some of you may know this is the Latin American version of the "(tblank)Rails Rumble":http://railsrumble.com/ and, following the same concept, the registered teams will be trying to write a productive "(tblank)Rack":http://rack.rubyforge.org/ base web application, from scratch, in just 48 hours.
...
h2. "(tblank)@elgalu":http://twitter.com/elgalu
...
h2. "(tblank)@jmoren_06":http://twitter.com/jmoren_06
